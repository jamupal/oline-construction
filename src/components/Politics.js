...
const Politics = () => {
  ...
  return (
        ...
        <Container maxWidth="lg">
          <Grid container spacing={1}>
            <Grid item xs={12} sm={12} >
                <Box  textAlign="center"><h1>Esta página cubre lo siguiente:</h1></Box>
            
                <Box><h3>Terminos de uso</h3></Box>
                <Box><p>• Estos Términos de uso estándar del sitio web escritos en esta página web administrarán su uso de este sitio web.
                        • Estos Términos se aplicarán completamente y afectarán su uso de este sitio web.
                        • Al usar este sitio web, acordó aceptar todos los Términos de uso escritos aquí.
                        • No debe usar este sitio web si no está de acuerdo con alguno de estos Términos de uso estándar del sitio web.</p></Box>
        <Box>
        <h3>Introducción</h3>
    ...
    <Box>
        <h3>Agente de derechos de autor</h3>
    ...
    <Box>
        <h3>Política de cuenta de usuario</h3>
    ...
    <Box>                        
        <h3>Política de uso razonable</h3>
    ...
    <Box>
        <h3>Violaciones y Terminación de Cuentas</h3>
    ...
    <Box>
        <h3>Cambios a estos Términos de uso</h3>
    ...
    <Box>
        <h3>Contactando con nosotros</h3>
